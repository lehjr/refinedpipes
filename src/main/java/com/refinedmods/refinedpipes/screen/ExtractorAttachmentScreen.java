...
public class ExtractorAttachmentScreen extends BaseScreen<ExtractorAttachmentContainer> {
    ...
    private ITextComponent getRedstoneModeText(RedstoneMode redstoneMode) {
    ...
    private TranslationTextComponent getBlacklistWhitelistText(BlacklistWhitelist blacklistWhitelist) {
    ...
    private TranslationTextComponent getRoutingModeText(RoutingMode routingMode) {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
        this.font.func_243248_b(matrixStack, this.title, 7, 7, 4210752);
        ...
        this.renderHoveredTooltip(matrixStack, mouseX - guiLeft, mouseY - guiTop);
        tooltip.clear();
        if (blacklistWhitelistButton.isHovered()) {
            tooltip.add(new TranslationTextComponent("misc.refinedpipes.mode"));
            tooltip.add(getBlacklistWhitelistText(container.getBlacklistWhitelist())
            ...
            tooltip.add(getRoutingModeText(container.getRoutingMode()).setStyle(Style.EMPTY.setFormatting(TextFormatting.GRAY)));
        } else if (exactModeButton.isHovered()) {
            tooltip.add(new TranslationTextComponent("misc.refinedpipes.exact_mode"));
            tooltip.add(getExactModeText(container.isExactMode()).setStyle(Style.EMPTY.setFormatting(TextFormatting.GRAY)));
        }
