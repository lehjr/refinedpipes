...
public class FluidPipeBlockItem extends BaseBlockItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add(new TranslationTextComponent(
            ...
            new StringTextComponent(StringUtil.formatNumber(type.getCapacity()) + " mB").setStyle(Style.EMPTY.setFormatting(TextFormatting.WHITE))
        ).setStyle(Style.EMPTY.setFormatting(TextFormatting.GRAY)));

        tooltip.add(new TranslationTextComponent(
            "tooltip.refinedpipes.fluid_pipe.transfer_rate",
            new StringTextComponent(StringUtil.formatNumber(type.getTransferRate()) + " mB/t").setStyle(Style.EMPTY.setFormatting(TextFormatting.WHITE))
        ).setStyle(Style.EMPTY.setFormatting(TextFormatting.GRAY)));
    }
}
